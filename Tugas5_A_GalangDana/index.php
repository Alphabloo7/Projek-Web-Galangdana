...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <!-- Logo -->
            <a href="login-admin.php" class="navbar-brand d-flex align-items-center">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Login & Sign Up -->
                <form class="d-flex">
                    <a class="btn btn-login me-2" href="pages/auth/Login.php">Login</a>
                    <a class="btn btn-signup" href="pages/auth/SignupUser.php">Sign Up</a>
                </form>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-12 col-md-6 text-justify">
                    ...
                    <p>Di dunia yang penuh dengan kebaikan, masih banyak orang yang membutuhkan uluran tangan.
                        Banyak orang yang ingin membantu sesama, tetapi sering kali kesulitan untuk menemukan cara yang
                        tepat.
                    ...
                    <p>Kami memiliki komitmen yang kuat untuk terus mengembangkan platform ini agar dapat menjangkau
                        ...
                        sama dengan
                        berbagai komunitasserta organisasi sosial guna memastikan bahwa setiap bantuan yang terkumpul
                        ...
                        dan mementingkan nilai nilai kehidupan sosial serta memberikan manfaat yang nyata begi mereka
                        yang membutuhkan.</p>
                </div>
  ...
  ";
    ...
    <div class="container-fluid p-0">
        <a id="how-to-donate">
            <img src="images/HowToDonate.png" class="img-fluid w-100" alt="How To Donate">
        </a>
    </div>
    <!-- End How To Donate -->
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text full-text" style="display: none;">Donasi telah tersalurkan untuk bencana
                                banjir di kota Semarang pada 17 Maret 2022. Donasi yang terkumpul berupa uang sejumlah
                                8.450.000. Terima Kasih atas bantuan yang telah anda diberikan untuk korban bencana ini.
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="card-text short-text">Pada 15 Desember 2022, tim kami telah menyalurkan donasi
                                berupa bahan makanan pokok serta uang tunai sejumlah 3.450.000 kepada warga terdampak
                            ...
                            <p class="card-text full-text" style="display: none;">Pada 15 Desember 2022, tim kami telah
                                menyalurkan donasi berupa bahan makanan pokok serta uang tunai sejumlah 3.450.000 kepada
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="card-text short-text">Dengan penuh rasa syukur, kami sampaikan bahwa donasi yang
                                telah terkumpul telah berhasil disalurkan kepada para korban bencana tanah longsor di
                                Batam pada 16 Juni 2023.</p>
                            <p class="card-text full-text" style="display: none;">Dengan penuh rasa syukur, kami
                                sampaikan bahwa donasi yang telah terkumpul telah berhasil disalurkan kepada para korban
                                bencana tanah longsor di Batam pada 16 Juni 2023. Bantuan tersebut diharapkan dapat
                                meringankan beban mereka dan membantu proses pemulihan di tengah situasi yang sulit ini.
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="card-text short-text">Kami beritahukan pada 18 Desember 2023, donasi yang telah
                            ...
                            <p class="card-text full-text" style="display: none;">Kami beritahukan pada 18 Desember
                                ...
                                gempa di Cianjur. Semoga bantuan tersebut dapat membantu meringankan kesulitan mereka
                                dan mendukung pemulihan kehidupan sehari-hari. Kami ucapkan terima kasih atas dukungan
            ...
            <div class="row">
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <p class="text-body-secondary">
                        ...
                        keperluan, mulai dari bantuan medis, pendidikan, hingga proyek sosial. Kami berkomitmen untuk
                ...
                <div class="col-6 col-md-2 mb-3">
                    <h5>Kontak</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><span class="nav-link p-0 text-body-secondary">Alamat: Jl. Jend. Urip
                                Sumoharjo No.116 Jebres, Kota Surakarta, Jawa Tengah 57129</span></li>
                        <li class="nav-item mb-2"><a href="https://wa.me/6281234567890"
                                class="nav-link p-0 text-body-secondary" target="_blank">WhatsApp: +62 812-3456-7890</a>
                        </li>
                    </ul>
                </div>
