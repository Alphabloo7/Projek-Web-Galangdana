...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($password !== $verify) {
    ...
    $check_email = "SELECT * FROM mitra WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
      ...
      // Insert user baru
      $sql = "INSERT INTO mitra (nama_mitra, no_telepon, alamat, password, email) VALUES (?, ?, ?,?,?)";
      $stmt = $conn->prepare($sql);
      $stmt->bind_param("sssss", $nama_mitra, $no_telepon, $alamat, $hashed_password, $email);
    ...
    <div class="content">
      ...
      <form action="#" method="post">
        <div class="part-form">
          ...
          <input type="text" name="nama_mitra" id="nama_mitra" class="form-input-nama_mitra" placeholder="Your name" required>
        </div>
        <div class="part-form">
