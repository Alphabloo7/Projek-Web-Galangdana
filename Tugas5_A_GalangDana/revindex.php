    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="From-5.php">Apply For Donation</a>
          </li>
          <li class="nav-item">
    ...
    <div class="album py-5 bg-body-tertiary">
      <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          <?php
          // Contoh dengan tanggal dan waktu yang dikustomisasi
          echo generateDonationCard(
            ...
            "2025-04-19", // Tanggal custom
            "2 hours ago" // Waktu custom
          );
          ...
          echo generateDonationCard(
            ...
            "2004-12-26", // Tanggal custom
            "20 years ago" // Waktu custom
          );
          ...
          echo generateDonationCard(
            ...
            "2025-03-15", // Tanggal custom
            "1 month ago" // Waktu custom
          );
          ...
          echo generateDonationCard(
            ...
            "2025-04-10", // Tanggal custom
            "1 week ago" // Waktu custom
          );
          ...
          echo generateDonationCard(
            ...
            "2024-03-22", // Tanggal custom
            "1 year ago" // Waktu custom
          );
          ...
          echo generateDonationCard(
            ...
            "2025-02-28", // Tanggal custom
            "2 months ago" // Waktu custom
          );
          ?>
        </div>
      </div>
